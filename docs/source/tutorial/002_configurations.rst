.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_tutorial_002_configurations.py>`     to download the full example code
    .. rst-class:: sphx-glr-example-title

    .. _sphx_glr_tutorial_002_configurations.py:
...
.. _sphx_glr_download_tutorial_002_configurations.py:
